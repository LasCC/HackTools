  ...
  return (
    <Row gutter={[16, 16]}>
      <Col xs={24}>
        ...
        <Typography.Text type="secondary">This tool help generate mutation based on a provided IPv4 address for obfuscation or filter bypass purposes.</Typography.Text>
      </Col>
      <Col xs={24}>
        <Input
      ...
      <Col xs={24}>
        <Button type="primary" onClick={handleCopy}>Copy All</Button>
      </Col>
      <Col xs={24}>

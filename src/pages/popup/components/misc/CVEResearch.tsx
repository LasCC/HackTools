	  ...
	  search: [
		{
		  ...
		  flatDescription: "Rock Lobster Contact Form 7 before 3.7.2 allows remote attackers to bypass the CAPTCHA protection mechanism and submit arbitrary form data by omitting the _wpcf7_captcha_challenge_captcha-719..."
		},
		{
		  _index: "es6_bulletins_bulletin_v3",
		  _type: "_doc",
		  ...
		  _source: {
			...
			description: " Check-WP-CVE-2020-35489\n\n CVE-2020-35489\nThe CVE-2020-35489 ...",
			modified: "2022-08-11T09:41:06",
			published: "2020-12-24T09:10:17",
			id: "8013AE2F-877F-598C-B69A-FB4E7CDE9D77",
			href: "",
			type: "githubexploit",
			title: "Exploit for Unrestricted Upload of File with Dangerous Type in Rocklobster Contact Form 7",
			cvss: {
			  score: 10,
			  vector: "AV:N/AC:L/Au:N/C:C/I:C/A:C"
			},
			privateArea: 1,
			vhref: "https://vulners.com/githubexploit/8013AE2F-877F-598C-B69A-FB4E7CDE9D77"
		  },
		  highlight: {},
		  sort: [
			3.8811315e-8,
		  ...
		  flatDescription: "Check-WP-CVE-2020-35489 CVE-2020-35489 The CVE-2020-35489..."
		},
		{
		  _index: "es6_bulletins_bulletin_v3",
		  _type: "_doc",
		  ...
		  _source: {
			...
			privateArea: 1,
			vhref: "https://vulners.com/githubexploit/A9AF97E8-458C-5B4F-B974-5762CA37AB0B"
		  },
		  highlight: {},
		  sort: [
			1.473818e-37,
		...
		},
		{
		  ...
		  flatDescription: "Exploit Title: Wordpress Plugin Contact Form 7 5.3.1 - Unrestricted File Upload Date: 12/20/2020 Exploit Author: Ramón Vila Ferreres (@ramonvfer) Vendor Homepage: https://contactform7.com Software Link: https://wordpress.org/plugins/contact-form-7/ Version: 5.3.1 and below Tested on: Windows 10..."
		},
		{
		  _index: "es6_bulletins_bulletin_v3",
		  _type: "_doc",
		  ...
		  _source: {
			...
			sourceHref: "https://packetstormsecurity.com/files/download/160630/wpcontactform7531-shell.txt",
		  ...
		  flatDescription: "` Exploit Title: Wordpress Plugin Contact Form 7 5.3.1 - Unrestricted File Upload   Date: 12/20/2020 Exploit Author: Ramón Vila Ferreres (@ramonvfer) Vendor Homepage: https://contactform7.com Software Link: https://wordpress.org/plugins/contact-form-7/ Version: 5.3.1 and below Tested on: Windows..."
		},
		{
		  _index: "es6_bulletins_bulletin_v3",
		  _type: "_doc",
		  ...
		  _source: {
			...
			vhref: "https://vulners.com/threatpost/THREATPOST:0E15C66722D04D8B54AE59F8976CEDAF"
		  },
		  highlight: {
			references: [
		  ...
		  flatDescription: "A patch for the popular WordPress plugin called Contact Form 7 was released Thursday. It fixes a critical bug that allows an unauthenticated adversary to takeover a website running the plugin or possibly hijack the entire server hosting the site. The patch comes in the form of a 5.3.2 version..."
		},
		{
		  _index: "es6_bulletins_bulletin_v3",
		  _type: "_doc",
		  ...
		  _score: 0,
		  _ignored: [
			"enchantments.twitter.tweets.text.keyword"
		  ],
		  _source: {
		  ...
		  flatDescription: "The contact-form-7 (aka Contact Form 7) plugin before 5.3.2 for WordPress allows Unrestricted File Upload and remote code execution because a filename may contain special..."
		},
		{
		  _index: "es6_bulletins_bulletin_v3",
		  _type: "_doc",
		  ...
		  _source: {
			...
			sourceData: "Append a unicode special character (from U+0000 [null] to U+001F [us]) to a filename and upload it via the ContactForm7 upload feature",
			cvss: {
			  score: 10,
			  vector: "AV:N/AC:L/Au:N/C:C/I:C/A:C"
			},
			vhref: "https://vulners.com/wpexploit/WPEX-ID:7391118E-EEF5-4FF8-A8EA-F6B65F442C63"
		  },
		  highlight: {
			references: [
		  ...
		  flatDescription: "The popular WordPress plugin, Contact Form 7 was found to be vulnerable to Unrestricted File Upload.  Append a unicode special character (from U+0000 [null] to U+001F [us]) to a filename and upload it via the ContactForm7 upload..."
		},
		{
		  _index: "es6_bulletins_bulletin_v3",
		  _type: "_doc",
		  ...
		  _source: {
			...
			vhref: "https://vulners.com/wpvulndb/WPVDB-ID:7391118E-EEF5-4FF8-A8EA-F6B65F442C63"
		  },
		  highlight: {
			references: [
			  "https://<span class=\"vulners-highlight\">contactform7</span>.com/2020/12/17/contact-form-7-532/more-38314",
		  ...
		  flatDescription: "The popular WordPress plugin, Contact Form 7 was found to be vulnerable to Unrestricted File Upload. PoC Append a unicode special character (from U+0000 [null] to U+001F [us]) to a filename and upload it via the ContactForm7 upload..."
		},
		{
		  _index: "es6_bulletins_bulletin_v3",
		  _type: "_doc",
		  ...
		  _source: {
			...
			bulletinFamily: "software",
			cvelist: [],
			description: "The Flamingo WordPress plugin was affected by a CSV Injection security vulnerability",
			...
			vhref: "https://vulners.com/wpvulndb/WPVDB-ID:810A985F-B671-4A69-B9C3-7F35D72E84DE"
		  },
		  highlight: {
			references: [
		  ...
		  flatDescription: "The Flamingo WordPress plugin was affected by a CSV Injection security..."
		}
	  ],
	  exactMatch: null,
	  references: null,
            ...
            <List.Item>
              <Card title={item._source.title} style={{width:'100%'}} >
                <Space direction='vertical'>
                  <Text><strong>Description:</strong> {item._source.description}</Text>
                  <Text><strong>Type:</strong> {item._source.type}</Text>
                  <Text><strong>Bulletin Family:</strong> {item._source.bulletinFamily}</Text>
                  <Text><strong>CVSS Score:</strong> {item._source.cvss.score}</Text>
                  <Text><strong>Published:</strong> {item._source.published}</Text>
                  <Text><strong>Modified:</strong> {item._source.modified}</Text>
                  <Text><strong>Last Seen:</strong> {item._source.lastseen}</Text>
                  <Text><strong>Source:</strong> <a href={item._source.sourceHref}>Link</a></Text>
                </Space>
              </Card>
            </List.Item>
          )}

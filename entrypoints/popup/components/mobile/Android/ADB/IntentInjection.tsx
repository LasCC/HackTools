      ...
      <Col span={24}>
        <Form onFinish={generatePOC}>
          <Form.Item label="Activity">
            <Input
              placeholder={`Provide com.app.RenderWebViewActivity or the whole xml tag : <activity android:name='com.app.RenderWebViewActivity' .../>`}
              value={className}

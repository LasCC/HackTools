...
const CommandNavigation = () => {
  const { setIndex, setHackToolsState, darkMode, setDarkModeState } =
    useStore();
  const [page, setPage] = useState<
    "root" | "Web" | "System" | "Mobile" | "Tools"
  >("root");
        ...
        items: [
          {
            ...
            icon: <SiGnubash style={{ fontSize: "1.3em", marginTop: 3 }} />,
            closeOnSelect: false,
            onClick: () => {
              setIsOpen(false);
              setIndex("1");
        ...
        items: [
          {
            ...
            children: "Web",
            icon: (
              <BsBrowserChrome style={{ fontSize: "1.3em", marginTop: 3 }} />
            ),
            closeOnSelect: false,
            onClick: () => {
              setPage("Web");
          ...
          },
          {
            ...
            children: "Mobile",
            icon: (
              <BiMobileVibration style={{ fontSize: "1.3em", marginTop: 3 }} />
            ),
            closeOnSelect: false,
            onClick: () => {
              setPage("Mobile");
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            onClick: () => {
              window
                .open("https://github.com/LasCC/Hack-Tools/issues", "_blank")
                .focus();
              setIsOpen(false);
            },
          },
          {
            ...
            children: "Bug Report",
            icon: (
              <AiOutlineGithub style={{ fontSize: "1.3em", marginTop: 3 }} />
            ),
            closeOnSelect: false,
            onClick: () => {
              window

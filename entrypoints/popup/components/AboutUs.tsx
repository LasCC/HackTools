...
export default function AboutUs() {
	return (
		<div>
			...
			>
				<Paragraph>
					HackTools, is a web extension facilitating your web application
					penetration tests, it includes cheat sheets as well as all the tools
					used during a test such as XSS payloads, Reverse shells and much more.
					With the extension you no longer need to search for payloads in
					different websites or in your local storage space, most of the tools
					are accessible in one click. HackTools is accessible either in pop up
			...
			>
				...
				<Paragraph>
					We are always looking for community input into our software. Feel free
					to contribute to the Hack-Tools repository:
				</Paragraph>
				<Paragraph>
					- Contribute the project:{" "}
					<Link href="https://github.com/LasCC/Hack-Tools" target="_blank">
				...
				<Paragraph>
					If you encounter a problem that was reported and closed, check why it
					was closed and if you think it should be reopened, open a new issue
					instead.
				</Paragraph>
				<Paragraph>
					- Report a bug:{" "}
					<Link
						...
						target="_blank"
					>
						https://github.com/LasCC/Hack-Tools/issues
					</Link>
				</Paragraph>
			</div>
			<Divider dashed />
			...
			>
				...
				<Paragraph> GTFOBins </Paragraph> <Paragraph> Antd </Paragraph>{" "}
				...
				<Paragraph>
					{" "}
					Thanks to dejisec for the Active Directory scripts !{" "}
					<Link

...
const ChainInput = () => {
	...
	const badges = exceededServers.map((server) => (
		<Badge count={server} style={{ backgroundColor: "#f5222d" }} />
	));
			...
			<div>
				...
				<Typography.Paragraph>
					...
					<a
						onClick={() =>
							window.open(
								"https://www.synacktiv.com/en/publications/php-filters-chain-what-is-it-and-how-to-use-it#from-hacktools",
								"_blank"
							)
						}
					>
					...
					done by <b>Rémi Matasse (@remsio-syn from Synacktiv)</b> all credits
					goes to him.
				</Typography.Paragraph>
				<Typography.Paragraph>
					This is an implementation in Javascript of the original{" "}
					<a
						onClick={() =>
							window.open(
								"https://github.com/synacktiv/php_filter_chain_generator#from-hacktools",
								"_blank"
							)
						}
					>
					...
					. By using multiple chain of php encoding wrappers, this technique can
					turn file inclusion primitive into remote code execution without
					upload.
				</Typography.Paragraph>
				<Input
					value={chainInput}

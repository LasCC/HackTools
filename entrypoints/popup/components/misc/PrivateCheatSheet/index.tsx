...
const index = () => {
  const {
    ...
    importPayloadFromURL,
    importPayloadsFromLocalFile,
    payloads,
    setPayloads,
    remotePayloadURL,
    setRemotePayloadURL,
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "tags",
      key: "tags",
      filters: Array.from(new Set(payloads.flatMap((item) => item.tags))).map(
  ...
  const helpModal = (
    ...
    >
      <Typography style={{ textAlign: "justify" }}>
        Here you can create your own set of payloads and save them to find them
        quickly later, you can fill it by importing a JSON file having the
        following structure for each payload.
      </Typography>
      <Paragraph>
        <pre>
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={24}>
          ...
          <Space.Compact style={{ width: "100%" }}>
            ...
            />
            <Button type="primary" onClick={importPayloadFromURL}>
              Submit
            </Button>
          </Space.Compact>
        </Col>
    ...
    <div>
      ...
      >
        ...
        <FloatButton
          ...
          tooltip={<div>Payload Managment</div>}
        />
      </FloatButton.Group>
      {helpModal}
      {syncModal}

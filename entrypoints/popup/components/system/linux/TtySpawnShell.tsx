      ...
      >
        <Space direction="vertical">
          ...
          <Paragraph>
            ...
            <pre>
              <Text>python3 -c 'import pty;pty.spawn("/bin/bash")'</Text>
            </pre>
            Which uses Python to spawn a better-featured bash shell. At this
            point, our shell will look a bit prettier, but we still won’t be
            able to use tab autocomplete or the arrow keys.
          </Paragraph>
          <Paragraph>
            <strong>Step two is:</strong>
            <pre>
              <Text copyable>export TERM=xterm</Text>
            </pre>
          ...
          <Paragraph>
            ...
            <pre>
              <Text copyable>Ctrl + Z</Text>
            </pre>
            Back in our own terminal we use
            <pre>
              <Text copyable>stty raw -echo; fg</Text>
            </pre>
            This does two things: first, it turns off our own terminal echo
            which gives us access to tab autocompletes, the arrow keys, and Ctrl
            + C to kill processes
            <pre>
